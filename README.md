...
1. **Yeni Çark Oluşturun**: Anasayfadaki "Yeni Çark" butonuna tıklayın
2. **Çarkınıza İsim Verin**: Örneğin "Akşam Yemeği", "Film Seçimi" veya "Hafta Sonu Planı"
3. **Seçenekleri Girin**: Karar vermek istediğiniz tüm seçenekleri ekleyin
4. **Çarkı Çevirin**: Çarkı çevirin ve kararınızı şansa bırakın!
5. **Keyfini Çıkarın**: Artık karar verme stresinden kurtuldunuz! 🥳

## 🚀 Kurulum

```bash
# Projeyi klonlayın
git clone https://github.com/ismailhakkii/karar_carki.git
...
Sevgiyle ❤️ tarafından geliştirilen bir uygulama:

**İsmail Hakkı** - [@ismailhakkii](https://github.com/ismailhakkii)
